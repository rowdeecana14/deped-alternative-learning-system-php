<?php
	...
	$sql = "SELECT * FROM tbl_learners WHERE status !='Deleted' AND category_of_learner LIKE '%OSC%' ORDER BY learner_fullname";
            ...
            <li ><a href="registration.php"><i class="fa fa-edit"></i> Registration</a></li>
			  <li class="dropdown active">
				  ...
				  <ul class="dropdown-menu" role="menu">
					...
					<li class="divider"></li>
					<li class="active"><a href="osc.php">Out of school children</a></li>
					<li class="divider"></li>
		 ...
		 <div class="panel panel-success">
			  <div class="panel-heading" style="background-color:#b1e2bd">
				  ...
				  <div class="pull-right" style="margin-top:-42px">
					  <a type="button" download="osc.xls" onclick="return ExcellentExport.excel(this, 'excel_table', 'Out_of_school_children');" class="btn btn-default">
				...
				<div class="col-md-3 col-sm-3 col-xs-3">
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12 responsive">
					  ...
					  <div class="table-responsive">
						  <hr>
						  <h3 id="title_name">LIST OF OUT OF SCHOOL CHILDREN<p class="pull-right">Total: <?php echo $osc; ?></p></h3>
						  <hr>
						  	...
						  	if($count == $end) {
								...
								if($count == 100) {
									...
									<div class="box-footer" style="border-top: 1px solid #afaaaa;">
										<p>Showing '.$count.' of '.$osc.' entries</p>
						  ...
						  <table id="excel_table" class="table hide" style="border: 1px solid black">
							  <thead style="background-color:#e2e2e2; " >
							<tr>
								  <td colspan="16"><h3>LIST OF OUT OF SCHOOL CHILDREN</h3></td>
							  </tr>
