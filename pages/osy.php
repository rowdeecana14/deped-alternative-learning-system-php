<?php
	...
	$sql = "SELECT * FROM tbl_learners WHERE status !='Deleted' AND category_of_learner LIKE '%OSY%' ORDER BY learner_fullname";
			 ...
			 <li class="dropdown active">
				  ...
				  <ul class="dropdown-menu" role="menu">
					...
					<li><a href="osa.php">Out of school adult</a></li>
					  <li class="divider"></li>
					<li  class="active"><a href="osy.php">Out of school youth</a></li>
				  </ul>
            </li>
		 ...
		 <div class="panel panel-success">
			  <div class="panel-heading" style="background-color:#b1e2bd">
				  ...
				  <div class="pull-right" style="margin-top:-42px">
					  <a type="button" download="osy.xls" onclick="return ExcellentExport.excel(this, 'excel_table', 'Out_of_school_youth');" class="btn btn-default">
				...
				<div class="col-md-3 col-sm-3 col-xs-3">
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12 responsive">
					  ...
					  <div class="table-responsive">
						  <hr>
						  <h3 id="title_name">LIST OF OUT OF SCHOOL YOUTH<p class="pull-right">Total: <?php echo $osy; ?></p></h3>
						  <hr>
						  	...
						  	if($count == $end) {
								...
								if($count == 100) {
									...
									<div class="box-footer" style="border-top: 1px solid #afaaaa;">
										<p>Showing '.$count.' of '.$osy.' entries</p>
						  ...
						  <table id="excel_table" class="table hide" style="border: 1px solid black">
							  <thead style="background-color:#e2e2e2; " >
							<tr>
								  <td colspan="16"><h3>LIST OF OUT OF SCHOOL YOUTH</h3></td>
							  </tr>
